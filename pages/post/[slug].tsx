    ...
    <main className="font-poppins grid grid-cols-7 ">
      ...
      <div className="border-gray-200  border-x-[1px] w-full h-full  col-span-7 xl:col-span-4 ">
        ...
        {up && (
          <div
            onClick={scrolltotop}
            className="fixed hidden sm:block animate-bounce duration-500 z-40 hover:bg-blue-700 bg-blue-600 shadow-xl cursor-pointer rounded-md p-[13px] m-10 bottom-0 right-0"
          >
              ...
              <div className="py-4">
                ...
                <div className="py-6">
                  {posts.slice(0, 5)?.map((post, id) => (
                    <Link passHref key={id} href={`/post/${post.slug.current}`}>
